...
#     mock_gpg_context = mocker.patch("passpie.cli.GPG")
#     mock_gpg_context().__enter__.return_value = mock_gpg
#     return mock_gpg
...
# def test_init_has_success_when_dir_exists_and_force_is_passed(mocker, mock_cryptor):
#     mocker.patch('passpie.cli.Repository')
#     mocker.patch('passpie.cli.os.remove')
#     mocker.patch('passpie.cli.os.path.isdir', return_value=True)
